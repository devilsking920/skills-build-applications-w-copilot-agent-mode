...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Activity.objects.create(user='spiderman', activity_type='cycle', duration=45, team='Marvel')
        Activity.objects.create(user='batman', activity_type='swim', duration=60, team='DC')
        Activity.objects.create(user='superman', activity_type='run', duration=50, team='DC')
